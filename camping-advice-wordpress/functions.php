...
if (! function_exists('my_theme_setup') ) :
    ...
    function my_theme_setup()
    {
        ...
        load_theme_textdomain('bootstrap-four', get_template_directory() . '/languages');
...
function my_scripts_own() 
{
    ...
    wp_register_script('boots', get_template_directory() . '/js/bootstrap.min.js', array('jquery'), '20161110', true);
    wp_register_script('collapse', get_template_directory() . '/js/bootstrap/collapse.js', array('jquery'), '20161110', true);
    wp_register_script('dropdown', get_template_directory() . '/js/bootstrap/dropdown.js', array('jquery'), '20161110', true);
    wp_register_script('transition', get_template_directory() . '/js/bootstrap/transition.js', array('jquery'), '20161110', true);
    wp_register_script('carousel', get_template_directory() . '/js/bootstrap/carousel.js', array('jquery'), '20161110', true);
    wp_register_script('tab', get_template_directory() . '/js/bootstrap/tab.js', array('jquery'), '20161110', true);
    wp_register_script('master', get_template_directory() . '/js/main.js', array('jquery'), '20161110', true);
