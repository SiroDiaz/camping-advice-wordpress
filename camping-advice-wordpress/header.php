...
<script src="js/old-browser-folder/Respond-master/dest/respond.min.js"></script>
<script src="js/old-browser-folder/html5shiv.min.js"></script>
<script src="js/old-browser-folder/selectivizr.min.js"></script>
<![endif]-->

    <?php wp_head(); ?>
>>>>>>> aa6f18f202d16c01773934c7be91883c8cfc8f42:camping-advice-wordpress/header.php
</head>
            ...
            <header>
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 ">
                    ...
                    <figure class="campuklogo">
                        <img src="<?php echo home_url(); ?>/wp-content/uploads/sites/4/2018/03/logo1.png" alt="Camping_Advice_Logo" />
                    </figure>
                    <?php else : ?>
                    <figure class="campuklogo">
                        <img src="<?php echo home_url(); ?>/wp-content/uploads/sites/4/2018/03/logo-blog.png" alt="Camping_Advice_Logo" />
                    </figure>
                    <?php endif; ?>
                </div>
